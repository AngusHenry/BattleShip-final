...
//                    System.out.println("row " + row);
   ...
   for (column =0; column < 10; column++){
       ...
       column = 0;
        ...
        use5 = 0;
        displayGrid(row, col);
        String[][] tracker = new String [10][10];
...
//                fire = input.nextLine();
                ...
                if (Grid[fireRow][fireCol] == 0){
                   ...
                   System.out.println("~~~~~~~~~~");
                            tracker[fireRow][fireCol] = "/";
                            output = "  ENEMY ALIENS GRID:\n"
...
//                    }
            ...
            if (use1 + use2 + use3 + use4 + use5 == 5){
                    ...
                    use4 = 0;
                    use5 = 0;
                    check1 = "Yes! Fire Away!";
                    check2 = "Yes! Fire Away!";
                    check3 = "Yes! Fire Away!";
                    check4 = "Yes! Fire Away!";
